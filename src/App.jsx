...
import outlinetstar from "./assets/img/outlinetstar.png";
        ...
        <div className=" p-10 bg-white flex flex-1 flex-col">
          <div className="flex justify-between credit-light  w-full">
            <div className="text-sm">
              Barclaycard CashForward<sup style={{ fontSize: "6px" }}>TM</sup>{" "}
              World MasterCard<sup style={{ fontSize: "6px" }}>TM</sup>
            </div>
            <div className="sm:flex hidden gap-2 items-center ">
              <div className="flex">
                <img src={fullstar} className="h-2" alt="" srcset="" />
                <img src={fullstar} className="h-2" alt="" srcset="" />
                <img src={fullstar} className="h-2" alt="" srcset="" />
                <img src={fullstar} className="h-2" alt="" srcset="" />
                <img src={outlinetstar} className="h-2" alt="" srcset="" />
              </div>
          ...
          <div>
            <div className="my-3 flex sm:flex-row flex-col gap-x-8 border-b-2 py-5">
              <div className="flex sm:block">
                ...
                <button className=" bg-orange-500 sm:block hidden text-white text-sm py-1 credit-header w-full mt-3 rounded-lg">
                  {" "}
                  Apply Now
                </button>
              </div>
            ...
            <div className="text-sm" style={{ color: "#9dd1fc" }}>
